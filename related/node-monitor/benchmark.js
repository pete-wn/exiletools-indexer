...
setInterval(function() {
  ...
  var filterCount = 0;
  var filterCountStart = process.hrtime();
  // this might be crappy, is just for testing
  _.forEach(filterData, function(thisFilter) {
    filterCount += _.size(thisFilter);
  });
  var filterCountEnd = process.hrtime(filterCountStart);
  console.log(time + " " + filterCount + " Filters in queue (this was calculated in " + prettyHrtime(filterCountEnd, {precise:true}));
