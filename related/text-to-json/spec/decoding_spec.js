...
frisby.create("[IDENTIFY] Rustic Sash")
  .post(baseurl, {
    'league':'Prophecy',
    'text': `Rarity: Normal
Rustic Sash
...
frisby.create("[IDENTIFY] Light Brigandine")
  .post(baseurl, {
    'league':'Prophecy',
    'text': `Rarity: Normal
Light Brigandine
...
Item Level: 15`
  ...
  .expectStatus(200)
  .expectJSON({
    info : { fullName : 'Light Brigandine' },
    attributes : {
      league: 'Prophecy',
      rarity: 'Normal',
      itemType: 'Body',
